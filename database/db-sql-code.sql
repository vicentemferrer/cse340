-- Postgre does not support ENUM type so it's necessary to declare a type for it
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO cse340vf;
--
...
--
-- Creating relation between both tables
